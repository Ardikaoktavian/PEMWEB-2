...
<?php 
   ...
   $ar_data[]=$_telepon_pelanggan;// 2
   $ar_data[]=$_nama_pelanggan;// 3
   $ar_data[]=$_telepon_pelanggan;// 4

   if($_proses == "Simpan"){
    // data baru
    $sql = "INSERT INTO pelanggan (id_pelanggan,email_pelanggan,
    nama_pelanggan,telepon_pelanggan) VALUES (?,?,?,?)";
   }else if($_proses == "edit"){
    $ar_data[]=$_POST['id'];// ? 8
    $sql = "UPDATE pelanggan SET id_pelanggan=?,email_pelanggan=?,nama_pelanggan=?,
