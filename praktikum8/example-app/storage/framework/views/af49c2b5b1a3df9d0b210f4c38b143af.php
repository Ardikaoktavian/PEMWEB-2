...
<!---- F O R M ---->
	...
	<form method="post" action="<?php echo e(route('user/pasien')); ?>">
		<?php echo csrf_field(); ?>
...
<script>
	// Kode untuk menghitung umur berdasarkan tgl_lahir
...
</html><?php /**PATH D:\xampp\htdocs\weblara\example-app\resources\views/user/pemeriksaan.blade.php ENDPATH**/ ?>