    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 header">
                <a href="list_produk.php"> Edit Produk </a>
            </div>
        </div>
        <div class="row main">
                ...
                <form method="POST" action="proses_produk.php">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="kode" 
                                ...
                                type="text" class="form-control" required="required" value="<?= $row['kode'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            ...
                            type="text" class="form-control" required="required" value="<?= $row['nama'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="harga" class="col-4 col-form-label">Harga Beli</label>
                        <div class="col-8">
                            <input name="harga_beli" id="harga" 
                            type="text" require class="form-control" value="<?= $row['harga_beli'] ?>" placeholder="000000" require="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="stok" class="col-4 col-form-label">Stok</label>
                        <div class="col-8">
                            <input id="stok" name="stok" placeholder="0" 
                            type="text" class="form-control" required="required" value="<?= $row['stok'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="min_stok" class="col-4 col-form-label">Minimum Stok</label>
                        <div class="col-8">
                            <input id="min_stok" name="min_stok" placeholder="0" 
                            type="text" class="form-control" required="required" value="<?= $row['min_stok'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="offset-4 col-8">
                            ...
                            style="background-color:#1A2140;border-color:#1A2140;" 
                            value="Update" onclick="if(!confirm('Anda Yakin Ingin Mengubah Data Produk <?= $row['nama'] ?>?')) {return false}">Ubah Data</button>
